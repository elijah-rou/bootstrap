...
- **Actuator** — what applies the change: a headless coding-agent run using a repo-local skill in an isolated workspace, producing a reviewable patch and evidence.
