...
assert.deepEqual(settings.npmCommand, ['bun'], 'Pi settings must use npmCommand: ["bun"]');
...
// Resolve the actual updater without fetching a version or replacing the running CLI.
